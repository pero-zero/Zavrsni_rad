...
namespace ServisProjekt.Migrations
{
    ...
    [Migration("20190926174931_OtpisKolicina")]
    partial class OtpisKolicina
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ServisProjekt.Models.OtpisSaSkladišta", b =>
                {
                    b.Property<int>("OtpisSaSkladištaID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("OtpisSaSkladištaID");

                    b.HasIndex("PredmetID");

                    b.HasIndex("RadniNalogID");

                    b.ToTable("OtpisSaSkladišta");
                });
            ...
            modelBuilder.Entity("ServisProjekt.Models.RadniNalog", b =>
                {
                    b.Property<int>("RadniNalogID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("ServisProjekt.Models.OtpisSaSkladišta", b =>
                {
                    b.HasOne("ServisProjekt.Models.Predmet", "Predmet")
                        .WithMany()
                        .HasForeignKey("PredmetID");

                    b.HasOne("ServisProjekt.Models.RadniNalog", "RadniNalog")
                        .WithMany()
            ...
            modelBuilder.Entity("ServisProjekt.Models.RadniNalog", b =>
                {
                    b.HasOne("ServisProjekt.Models.ApplicationUser", "Korisnik")
                        .WithMany()
                        .HasForeignKey("KorisnikID");

                    b.HasOne("ServisProjekt.Models.Narudžba", "Narudžba")
                        .WithMany()
                        .HasForeignKey("NarudžbaID")
                        .OnDelete(DeleteBehavior.Cascade);
                });
